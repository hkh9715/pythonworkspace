...
def main():
    ...
    img1 = cv.imread('.\stitch_img2.jpg') 
    img2 = cv.imread('.\stitch_img1.jpg')
    ...
    dst = cv.resize(result, dsize=(640, 480), interpolation=cv.INTER_AREA)
    dst2 = cv.resize(img_matching_result, dsize=(640, 480), interpolation=cv.INTER_AREA)
    cv.imshow('result', dst)
    cv.imshow('matching result', dst2)
